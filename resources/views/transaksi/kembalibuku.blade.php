...
<div class="row col-md-11 mt-5 border border-dark">
    <div class="table-container">
      ...
      <form action="/cetak-kembali?s={{ request('s') }}&tanggal_awal={{ request('tanggal_awal') }}&tanggal_akhir={{ request('tanggal_akhir') }}" class="mt-3" method="get">
        <div class="row">
            <div class="col-md-3">
                <label for="tanggal_awal" class="fw-bold">Tanggal Awal</label>
                <input type="date" name="tanggal_awal" id="tanggal_awal" class="form-control" value="{{ request('tanggal_awal') }}">
          ...
          <div class="col-md-4 mt-2">
              <button type="submit" class="btn btn-primary shadow mt-3">Cetak Laporan Transaksi Pengembalian Buku</button>
          </div>
    </form>
@endsection